...
using Book.Infrastructure.EntityTypeConfigs;
using MediatR;
...
namespace Book.Infrastructure
{
    public class BookingContext : DbContext, IUnitOfWork
    {
        ...
        {
            modelBuilder.ApplyConfiguration(new BookerEntityTypeConfiguration());
            modelBuilder.ApplyConfiguration(new BookTicketEntityTypeConfiguration());
        }
